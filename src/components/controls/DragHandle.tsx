...
export const DragHandle = ({ onDragStart, onDragEnd, className }: Props) => {
  const baseClasses = 'p-1.5 rounded-md cursor-grab active:cursor-grabbing';
  const defaultColorClasses = 'text-gray-400 hover:bg-gray-100 hover:text-gray-700';
  ...
  return (
    <div
      ...
      title="Drag to move"
    >
      <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg" className='h-5 w-5'>
