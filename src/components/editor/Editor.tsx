      ...
      <div className="flex-1 w-full max-w-4xl mx-auto space-y-4">
        ...
        >
          {components.length === 0 ? (
            ...
            <div className={`transition-colors duration-200 h-96 w-full border-2 border-dashed rounded-lg flex items-center justify-center ${isDragging && dragOverIndex === 0
